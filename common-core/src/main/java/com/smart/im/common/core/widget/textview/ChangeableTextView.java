package com.smart.im.common.core.widget.textview;
...
public class ChangeableTextView extends TextView {
    ...
    //设置动画要作用的最低行数 默认三行
    private int lines = 3;
    private int animBackgroundColor = Color.LTGRAY;
    ...
    private void init(Context context) {
        ...
        Log.e("xw","height："+getLineHeight()+"");
        Log.e("xw","paddBottom："+getPaddingBottom()+"");
        Log.e("xw","paddTop："+getPaddingTop()+"");
