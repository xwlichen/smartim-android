...
import com.smart.im.common.core.Constants;
...
public class GlobalHttpHandlerImpl implements GlobalHttpHandler {
    ...
    public Response onHttpResultResponse(String httpResult, Interceptor.Chain chain, Response response) {
        ...
        String token = response.header(Constants.TOKEN);
        if (!TextUtils.isEmpty(token)) {
            DataHelper.saveDeviceData(context, Constants.TOKEN, token);
        }
        return response;
    }
    ...
    public Request onHttpRequestBefore(Interceptor.Chain chain, Request request) {
        ...
        String token = DataHelper.getDeviceData(context, Constants.TOKEN);
        if (TextUtils.isEmpty(token)) {
            token = "";
        }
