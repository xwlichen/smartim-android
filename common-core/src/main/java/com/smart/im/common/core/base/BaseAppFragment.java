 ...
 */
package com.smart.im.common.core.base;
 ...
 * 继承于这个特定的 @{@link Fragment}, 然后再按照 {@link BaseAppFragment} 的格式, 将代码复制过去, 记住一定要实现{@link IFragment}
 *
 ...
 * ================================================
 */
public abstract class BaseAppFragment<P extends IPresenter> extends Fragment implements IFragment, FragmentLifecycleable {
